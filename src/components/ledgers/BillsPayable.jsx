                ...
                <table className="min-w-full">
                  <thead className="">
                    <tr className="border-y-2 border-gray-400 ">
                      ...
                      <th className=" w-3/5 text-left pl-40">Party's Name</th>
                      ...
                      tableData.map((item, i) => {
                        return (
                          <tr key={i}>
                            ...
                            <td>{item.ref}</td>
                            <td className=" pl-36 text-left font-medium">
                              {item.name}
                            </td>
                            <td className="text-right font-medium">
                              {item.amount}
                            </td>
                            <td className="text-right ">{item.dueOn}</td>
                            <td className="text-right italic font-medium w-16">
                              {item.overDue}
                            </td>
                          </tr>
                        );
